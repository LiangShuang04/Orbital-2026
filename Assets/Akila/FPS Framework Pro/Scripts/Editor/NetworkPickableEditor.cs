...
namespace Akila.FPSFrameworkPro
{
    ...
    public class NetworkPickableEditor : Editor
    {
        ...
        private SerializedProperty cleanIfEmptyProp;
        ...
        private void OnEnable()
        {
            ...
            cleanIfEmptyProp = serializedObject.FindProperty("clearIfEmpty");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (type == PickableType.Item)
            {
                ...
                if (pickable.TryGetComponent<NetworkPickable>(out NetworkPickable networkPickable))
                {
                    if (pickable.itemToPickup && !pickable.itemToPickup.GetComponent<NetworkInventoryItem>())
                    {
                        EditorGUILayout.HelpBox("'Item To Pickup' must be a networked InventoryItem. Please attach a NetworkInventoryItem component or one of its derived types.", MessageType.Error);
                    }
                }
            }
            ...
            EditorGUILayout.PropertyField(cleanIfEmptyProp, new GUIContent("Clear If Empty", "If 'Ammo To Collect' is zero or less pickable is destoryed."));
